...
//
var version = 'Embot V 1.x Dev; private release for Death | Death: Alpha 0.5 Dev'
var dprefix = `n!`
//
// CORE STUFF END
...
bot.on('guildCreate', (guild) => { // Log create guild
  ...
  bot.createMessage('361246399922307073', {
    embed: {
      ...
      description: `Death was added to: ${guild.name}`,
      fields: [
        {
          name: 'ID:',
          value: `${guild.id}`,
  ...
  bot.createMessage(msg.channel.id, {
    embed: {
      ...
      fields: [
        {
          name: 'Support Server',
          value: 'Death Join Death's server : https://discord.gg/JtbEDuf',
          inline: false
        }
      ]
    }
...
bot.registerCommand('invite', (msg, args) => {
  bot.createMessage(msg.channel.id, {
    embed: {
      ...
      footer: {
        icon_url: bot.user.avatarURL,
        text: 'Invite link: https://discord.gg/JtbEDuf'
      },
      fields: [
        {
          name: 'Invite',
